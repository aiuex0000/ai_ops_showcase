...
このフォルダは、このワークスペースで育ててきた **AI 実務運用の設計** を、個人情報や濃い人格設定を取り除いた形で見せるための成果物です。
...
詳しい基準は [sanitization_policy.md](./sanitization_policy.md) にまとめています。
...
という場面では、十分に土台として使えます。# ai_ops_showcase
